...
from services import BDUConnector  # type: ignore
from services.utils import MAX_AUTHORIZED, ConfigBDU  # type: ignore
...
class BDUConnector:
    ...
    def vulnerabilities_to_stix2(self) -> list:
        ...
        # URL of the zip file
        zip_file_url = 'https://example.com/path/to/your/zipfile.zip'
        ...
        for vul in xmlroot:
            ...
            for vul_param in vul:
                if vul_param.tag == "identifier":
                    ...
                    created_date = datetime.datetime.strptime(vul_param.text,"%Y-%m-%d")
                    ...
                    for cvss_param in vul_param:
                        if cvss_param.tag == "vector":
                            ...
                            base_score = cvss_param.attrib['score']
            ...
            external_reference = stix2.ExternalReference(
                source_name="bdu", url=f"https://bdu.fstec.ru/vul/{name.split(":"[1])}"
            )
    ...
    def process_data(self) -> None:
        try:
            ...
            self.converter.send_bundle(work_id)
